...
COS_API_KEY_ID="tpbPYxhQkDZyRyncFN7nEquORb0b77P0YXHtu3MvygEd"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/29ba3af72819429e92837d9c01833b5b:b75d65fa-42c0-41f4-bfe9-2ec416c130d2::"
...
@app.route('/')
def index():
    files = get_bucket_contents('bathri')
